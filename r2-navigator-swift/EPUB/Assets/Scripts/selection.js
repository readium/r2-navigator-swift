...
(function() {
    ...
    // Exports
    readium.getSelectionRect = getSelectionRect;
    readium.getCurrentSelectionInfo = getCurrentSelectionInfo;
    readium._convertRangeInfo = convertRangeInfo;
    readium._location2RangeInfo = location2RangeInfo;
    ...
    function log() {
        if (debug) {
            readium.log.apply(null, arguments);
        }
    }
})();